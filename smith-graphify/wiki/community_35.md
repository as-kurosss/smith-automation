...
- **.execute()** (`crates_smith_windows_src_tools_set_text_rs_settexttool_execute`, Method, degree: 2)
- **.name()** (`crates_smith_windows_src_tools_set_text_rs_settexttool_name`, Method, degree: 1)
